...
class Interface{
	public:		
		...
		void blink_success(SUCCESS type);
		void blink_error(ERROR type);
		static void print_message(MESSAGE m,int data);
		static void print_sending_data(unsigned int data[]);
		static void print_sent_message(const char msg[]);
