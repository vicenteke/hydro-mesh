// Coisas que são implementadas em hydro_thread_app
// 1) Retorna verdadeiro se mensagem enviada foi recebida (send())
// 2) Sincronização do tempo entre os dispositivos



// UART 0: PA0 (RX) / PA1 (TX)
// UART 1: PC5 (RX) / PC6 (TX)
...
// #include "lora_mesh/include/loraMesh2.h"
