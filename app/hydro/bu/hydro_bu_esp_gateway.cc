...
const RTC::Microsecond INTEREST_EXPIRY = 2 * INTEREST_PERIOD;
const RTC::Microsecond HTTP_SEND_PERIOD = 20ull * 60 * 1000000;
const unsigned int HTTP_SEND_PERIOD_MULTIPLY = 1;//2 * 12;
...
int main() {
    ...
    //Threads config
    new Periodic_Thread(INTEREST_PERIOD, &tstp_work, &rain);
    new Periodic_Thread(HTTP_SEND_PERIOD, &http_send, &rain);
