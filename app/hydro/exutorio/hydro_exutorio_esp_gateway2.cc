...
int main()
{
    ...
    //Stackers
    new Printer<Pressure_Keller_Capacitive>(new Pressure_Keller_Capacitive(0, INTEREST_EXPIRY, Pressure_Keller_Capacitive::PRIVATE, INTEREST_PERIOD));
    new Printer<Water_Turbidity_OBS>(new Water_Turbidity_OBS(0, INTEREST_EXPIRY, Water_Turbidity_OBS::PRIVATE, INTEREST_PERIOD));
    new Printer<Water_Turbidity_OBS>(new Water_Turbidity_OBS(1, INTEREST_EXPIRY, Water_Turbidity_OBS::PRIVATE, INTEREST_PERIOD));

    // new Printer<I2C_Temperature>(new I2C_Temperature(region_station1,INTEREST_EXPIRY,INTEREST_PERIOD));
