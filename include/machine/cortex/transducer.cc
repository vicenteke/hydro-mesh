...
Thread * ADC_Sensor_Test::_thread;
ADC_Sensor_Test::Readings ADC_Sensor_Test::_readings;
unsigned int ADC_Sensor_Test::_keys[ADC_Sensor_Test::MAX_CHANNELS];
...
Iluminance_Sensor::Observed Iluminance_Sensor::_observed;
OPT3001 * Iluminance_Sensor::_opt3001;
...
Accelerometer_LSM330::Data_Buffer * Accelerometer_LSM330::_data_buffer;
LSM330 * Accelerometer_LSM330::_imu;
Semaphore * Accelerometer_LSM330::_buffer;
Thread * Accelerometer_LSM330::_th_analyzer;
Observed Accelerometer_LSM330::_observed;
bool Accelerometer_LSM330::_initialized = false;
